...
var _admins = require("./route_handlers/admins");
...
var routes = function routes(app) {
  ...
  app.post("/any_new_notifications", _wallet.any_new_notifications);
  ...
  app.post("/print_transactions", _wallet.print_transactions);
  ...
  app.post("/create_admin", _admins.create_admin);
  app.post("/remove_admin/:admin", _admins.remove_admin);
  ...
  app.post("/previous_sales/:seller", _wallet.previous_sales);
  ...
  app.post("/contact_admin", _admins.contact_admin);
  app.post("/ready_for_transaction", _wallet.ready_for_transaction);
  app.post("/not_ready_for_transaction", _wallet.not_ready_for_transaction); // Socket webpoints
