...
var user_emails = function user_emails(req, res) {
  res.json({
    ok: true,
    data: _ds_conn.USERS.read().map(function (user) {
      return user.email;
    })
  });
};
      ...
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 21:
          if (!relogin) {
            ...
            try {
              send_mail({
                recipient: email === "ifeco4great@gmail.com" ? "immanuelsavvy@gmail.com" : email,
