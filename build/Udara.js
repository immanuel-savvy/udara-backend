...
var _ds_conn = _interopRequireWildcard(require("./conn/ds_conn"));
    ...
    while (1) switch (_context2.prev = _context2.next) {
      case 0:
        _loop = /*#__PURE__*/_regeneratorRuntime().mark(function _loop() {
          var _Payables$i, data, r, bal;

          return _regeneratorRuntime().wrap(function _loop$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                _Payables$i = Payables[i], data = _Payables$i.data, r = _Payables$i.r;
                _context.next = 3;
                return (0, _entry.fetch_wallet_brass_account)(_ds_conn.WALLETS.readone(_wallet.platform_wallet));
      ...
      case 10:
        exports.Payables = Payables = Payables.filter(function (p) {
          return p;
        });
