...
var referenceNumber = "".concat((0, _functions.generate_random_string)(14, "alnum")).concat(Date.now()),
    amount = "10",
    destinationBankUUID = "3E94C4BC-6F9A-442F-8F1A-8214478D5D86",
    destinationBankAccountNumber = "0273658996",
    hash = "8e9e7ae8368c444a875bbeba0f5f84b52aecc1500d624329b9ff572de7c1d86d618241f0b2834fb39a0e5c49906f1557ec464ddbe3c042119615a192f7a1c263"; // axios({
...
var paga_deposit = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(req, res) {
    var user, _req$body5, paymentAmount, collectionFee, event, statusCode, _amount;
        ...
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            if (statusCode === "0" && event === "PAYMENT_COMPLETE") {
              _amount = paymentAmount - collectionFee;
              user = _ds_conn.USERS.readone(user);
              user && topup({
                body: {
                  value: _amount,
          ...
          case 0:
            ...
            return (0, _axios["default"])({
              ...
              headers: {
                ...
                hash: (0, _jsSha["default"])(referenceNumber + amount + destinationBankUUID + destinationBankAccountNumber + hash)
              },
              data: {
...
var withdraw = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(req, res) {
    var _req$body8, user, amount, bank_account, wallet, user_obj, _yield$make_payment, response, reference_number;

    return regeneratorRuntime.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _req$body8 = req.body, user = _req$body8.user, amount = _req$body8.amount, bank_account = _req$body8.bank_account, wallet = _req$body8.wallet;
...
var remove_sale = function remove_sale(req, res) {
  ...
  var response = _ds_conn.ONSALE.remove(onsale._id, // { _id: onsale._id, currency },
  {
    subfolder: currency
  });
...
var fulfil_offer = function fulfil_offer(req, res) {
  var _req$body20 = req.body,
      ...
      buyer = _req$body20.buyer,
      seller = _req$body20.seller,
...
var deposit_to_escrow = function deposit_to_escrow(req, res) {
  var _req$body21 = req.body,
      ...
      buyer_wallet = _req$body21.buyer_wallet;
...
var confirm_offer = function confirm_offer(req, res) {
  var _req$body22 = req.body,
      ...
      seller_wallet = _req$body22.seller_wallet;
...
var offer_in_dispute = function offer_in_dispute(req, res) {
  ...
  var _req$body25 = req.body,
      ...
      initiator = _req$body25.initiator,
      onsale = _req$body25.onsale,
      prior_offer_status = _req$body25.prior_offer_status,
      seller = _req$body25.seller,
      buyer = _req$body25.buyer,
      title = _req$body25.title,
      details = _req$body25.details,
      currency = _req$body25.currency;
...
var add_bank_account = function add_bank_account(req, res) {
  var _req$body28 = req.body,
      bank = _req$body28.bank,
      bank_name = _req$body28.bank_name,
      user = _req$body28.user,
      wallet = _req$body28.wallet,
      account_number = _req$body28.account_number;
